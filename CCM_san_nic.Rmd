...
```{r red and macro}
mac_xmap_red <- ccm(block=composite.ts, lib=segments, pred=segments, E=6,lib_column = "mac",target_column = "red",
                     lib_sizes = c(seq(5,55,by=2),seq(55,400,by=50)),num_samples=100,silent=TRUE)

# to look at uni- vs. bi-directional causation, we also do the inverse (mac predicting red, E=best E for mac=4)
red_xmap_mac<- ccm(composite.ts, lib=segments, pred=segments, E=6,lib_column = "red",target_column = "mac",
                     lib_sizes = c(seq(5,55,by=2),seq(55,400,by=50)),num_samples=100,silent=TRUE)
...
```{r purple and macro}
mac_xmap_purp<- ccm(composite.ts, lib=segments, pred=segments, E=4,lib_column = "mac",target_column = "purp",
                     lib_sizes = c(seq(5,55,by=2),seq(55,400,by=50)),num_samples=100,silent=TRUE)

# to look at uni- vs. bi-directional causation, we also do the inverse (purp pmacicting mac, E=best E for purp=4)
purp_xmap_mac <- ccm(block=composite.ts, lib=segments, pred=segments, E=6,lib_column = "purp",target_column = "mac",
                     lib_sizes = c(seq(5,55,by=2),seq(55,400,by=50)),num_samples=100,silent=TRUE)
