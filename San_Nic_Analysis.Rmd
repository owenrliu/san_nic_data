...
plot(spe.ch.ord,hang=-1,xlab="3 groups",sub='',ylab='Height',main='Chord - UPGMA (reordered)', labels=cutree(spe.ch.ord,k=k), mar=(c(5,6,6,2)+0.1))
...
plot(spa,asp=1,type='n',main="Three UPGMA Groups",xlab='x coord(km)',ylab='y coord(km)')
